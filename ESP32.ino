...
static const int spiClk = 1000000; // 1 MHz clock for spi

//uninitalised pointers to SPI objects
SPIClass * vspi = NULL;
SPIClass * hspi = NULL;

int distance = 0;  //placeholder for ultrasonic distance
bool controller = false;  //initaliser contoller mode false

const uint16_t kRecvPin = 4;   //IR sensor pin
IRrecv irrecv(kRecvPin);      //recieving value from pin
decode_results results;       //being able to decode the results into hex form
unsigned long key_value = 0;   

volatile int interruptCounter;    //timer initialiser
